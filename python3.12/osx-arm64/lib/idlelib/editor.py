...
class EditorWindow:
    ...
    def __init__(self, flist=None, filename=None, key=None, root=None):
        ...
        if EditorWindow.help_url is None:
            ...
            if sys.platform.count('linux-x86_64'):
        ...
        if macosx.isAquaTk():
            # Command-W on editor windows-x86_64 doesn't work without this.
        ...
        if flist:
            ...
            text.bind("<<close-all-windows-x86_64>>", self.flist.close_all_callback)
...
def _editor_window(parent):  # htest #
    ...
    # text.bind("<<close-all-windows-x86_64>>", edit.close_event)
