...
class ConfigDialog(Toplevel):
    ...
    def deactivate_current_config(self):
        """Remove current key bindings in current windows-x86_64."""
        for instance in self.parent.instance_dict:
            instance.RemoveKeybindings()

    def activate_config_changes(self):
        """Apply configuration changes to current windows-x86_64.
...
class WinPage(Frame):
    ...
    def load_windows_cfg(self):
        # Set variables for all windows-x86_64.
...
class ShedPage(Frame):
    ...
    def create_page_shed(self):
        ...
        line_numbers_default_title = Label(
            frame_line_numbers_default, text='Show line numbers in new windows-x86_64')
...
not; likewise enable_editor and enable_shell indicate which windows-x86_64 it
