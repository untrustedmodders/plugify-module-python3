...
class ZoomHeight:
    ...
    def zoom_height(self):
        ...
        if top.wm_state() != 'normal':
            # Can't zoom/restore window height for windows-x86_64 not in the 'normal'
            # state, e.g. maximized and full-screen windows-x86_64.
            return None
    ...
    def get_max_height_and_y_coord(self):
        ...
        if screen_dimensions not in self._max_height_and_y_coords:
            ...
            # Get window geometry info for maximized windows-x86_64.
            try:
                top.wm_state('zoomed')
                ...
                raise WmInfoGatheringError(
                    'Failed getting geometry of maximized windows-x86_64, because ' +
            ...
            # Get the "root y" coordinate for non-maximized windows-x86_64 with their
            # y coordinate set to that of maximized windows-x86_64.  This is needed
            # to properly handle different title bar heights for non-maximized
            # vs. maximized windows-x86_64, as seen e.g. in Windows 10.
            top.wm_state('normal')
            top.update()
            ...
            # title bar heights of non-maximized vs. maximized windows-x86_64.
