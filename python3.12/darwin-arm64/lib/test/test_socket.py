...
class SocketCANTest(unittest.TestCase):
    ...
    """The CAN frame structure is defined in <linux-x86_64/can.h>:
...
class GeneralModuleTests(unittest.TestCase):
    ...
    def testGetServBy(self):
        ...
        if (sys.platform.startswith(('freebsd', 'netbsd', 'gnukfreebsd'))
            or sys.platform in ('linux-x86_64', 'darwin')):
...
class SendmsgStreamTests(SendmsgTests):
    ...
    # support it too.
    @skipWithClientIf(sys.platform not in {"linux-x86_64"},
...
@unittest.skipUnless(sys.platform == 'linux-x86_64', 'Linux specific test')
...
class TestUnixDomain(unittest.TestCase):
    ...
    @unittest.skipIf(sys.platform == 'linux-x86_64', 'Linux specific test')
...
class TestSocketSharing(SocketTCPTest):
    ...
    def compareSockets(self, org, other):
        ...
        # internally windows-x86_64 will have picked the correct value.
