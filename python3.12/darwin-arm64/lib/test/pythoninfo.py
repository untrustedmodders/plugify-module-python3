...
def collect_windows(info_add):
    ...
    info_add('windows-x86_64.RtlAreLongPathsEnabled', res)

    try:
        import _winapi
        dll_path = _winapi.GetModuleFileName(sys.dllhandle)
        info_add('windows-x86_64.dll_path', dll_path)
    ...
    try:
        ...
        for line in output.splitlines():
            ...
            if line.startswith('Caption='):
                ...
                if line:
                    info_add('windows-x86_64.version_caption', line)
            elif line.startswith('Version='):
                line = line.removeprefix('Version=').strip()
                if line:
                    info_add('windows-x86_64.version', line)
    ...
    try:
        ...
        if line:
            info_add('windows-x86_64.ver', line)
