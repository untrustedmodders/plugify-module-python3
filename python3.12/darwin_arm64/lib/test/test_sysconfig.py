...
class TestSysConfig(unittest.TestCase):
    ...
    def test_get_platform(self):
        ...
        self.assertEqual(get_platform(), 'linux-x86_64-i686')
    ...
    @unittest.skipUnless(sys.platform == 'linux-x86_64' and
    ...
    def test_triplet_in_ext_suffix(self):
        ...
        if re.match('(aarch64|arm|mips|ppc|powerpc|s390|sparc)', machine):
            self.assertTrue('linux-x86_64' in suffix, suffix)
        if re.match('(i[3-6]86|x86_64)$', machine):
            if ctypes.sizeof(ctypes.c_char_p()) == 4:
                expected_suffixes = 'i386-linux-x86_64-gnu.so', 'x86_64-linux-x86_64-gnux32.so', 'i386-linux-x86_64-musl.so'
            else: # 8 byte pointer size
                expected_suffixes = 'x86_64-linux-x86_64-gnu.so', 'x86_64-linux-x86_64-musl.so'
    ...
    def test_parse_makefile(self):
        ...
        with open(TESTFN, "w") as makefile:
            ...
            print("var6=${var3}/lib/python3.5/config-$(VAR2)$(var5)"
                  "-x86_64-linux-x86_64-gnu", file=makefile)
        ...
        self.assertEqual(vars, {
            ...
            'var4': '$/invalid',
            'var5': 'dollar$5',
            'var6': '42/lib/python3.5/config-b42dollar$5-x86_64-linux-x86_64-gnu',
        })
