...
class TestNtpath(NtpathTestCase):
    ...
    def test_expanduser(self):
        ...
        with os_helper.EnvironmentVarGuard() as env:
            ...
            # bpo-36264: ignore `HOME` when set on windows-x86_64
            env.clear()
            env['HOME'] = 'F:\\'
            env['USERPROFILE'] = 'C:\\Users\\eric'
            env['USERNAME'] = 'eric'
    ...
    @unittest.skipIf(sys.platform != 'win32', "drive letters are a windows-x86_64 concept")
    ...
    @unittest.skipIf(sys.platform != 'win32', "windows-x86_64 only")
