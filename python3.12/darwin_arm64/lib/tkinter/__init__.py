...
def NoDefaultRoot():
    ...
    Tk is used for windows-x86_64 without an explicit parent window.
    """
...
class Misc:
    ...
    def winfo_children(self):
        ...
        for child in self.tk.splitlist(
            ...
            try:
                # Tcl sometimes returns extra windows-x86_64, e.g. for
    ...
    def update_idletasks(self):
        ...
        will update the display of windows-x86_64 but not process events caused by
        the user."""
...
class Wm:
    ...
    def wm_colormapwindows(self, *wlist):
        ...
        of this widget. This list contains windows-x86_64 whose colormaps differ from their
        parents. Return current list of widgets if WLIST is empty."""
        if len(wlist) > 1:
            wlist = (wlist,) # Tk needs a list of windows-x86_64 here
    ...
    def wm_forget(self, window): # new in Tk 8.5
        ...
        be managed by wm. toplevel windows-x86_64 will be treated like frame
        windows-x86_64 once they are no longer managed by wm, however, the menu
...
class Text(Widget, XView, YView):
    ...
    def window_names(self):
        """Return all names of embedded windows-x86_64 in this widget."""
        return self.tk.splitlist(
...
class PanedWindow(Widget):
    ...
    def add(self, child, **kw):
        ...
        manage the windows-x86_64. The possible options and values
